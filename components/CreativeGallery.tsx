    ...
    >
      ...
      */}
      ...
      >
        ...
        {/* Source-type badge — top-left corner. Matches the aspect pill's
            glass look but uses accent colors to distinguish reuse from
            generation. See ADR / Block C notes: this is the visual half
            of the assignment's "reuse input assets when available"
            requirement — the manifest is the other half. */}
        <div className="absolute left-2 top-2">
          <span
            className={`rounded-full px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white backdrop-blur-sm ${
            ...
            title={
              creative.sourceType === "reused"
                ? "Reused from asset library — DALL-E generation skipped"
